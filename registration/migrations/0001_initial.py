# Generated by Django 3.1.1 on 2021-01-19 11:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('club', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Officials', to='registration.club')),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Official', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='ProfilePicture',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abbr', models.CharField(blank=True, max_length=4, null=True, unique=True, validators=[django.core.validators.MinLengthValidator(3)], verbose_name='Club abbreviation(3-4 characters)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invitation', to='registration.officials')),
            ],
            options={
